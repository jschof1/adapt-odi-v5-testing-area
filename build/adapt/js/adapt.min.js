require(['html-react-parser', 'semver', 'bowser', 'react', 'react-dom', 'libraries/mediaelement-and-player', 'libraries/rangeslider', 'libraries/draggabilly', 'libraries/lottie-player', 'libraries/lottie-interactivity.min', 'handlebars', 'libraries/SCORM_API_wrapper', 'underscore', 'libraries/lzma-min', 'libraries/lzma_worker-min.js', 'libraries/lottie.min'], function (HTMLReactParser, semver, Bowser, React, ReactDOM$1, mediaelementAndPlayer, rangeslider, Draggabilly, lottiePlayer, LottieInteractivity, Handlebars$1, pipwerks, _$1, lzmaMin, lzma_workerMin_js, Lottie) {
  ...
  var LottieView = __AMD("extensions/adapt-graphicLottie-master/js/LottieView", function (_Backbone$View) {
  ...
  __AMD("extensions/adapt-graphicLottie-master/js/adapt-graphicLottie", new GraphicLottie());
